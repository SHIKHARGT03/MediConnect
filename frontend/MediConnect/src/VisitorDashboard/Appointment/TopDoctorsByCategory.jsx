  ...
  useEffect(() => {
    const fetchDoctors = async () => {
      try {
        ...
        console.error("Error fetching top doctors by category:", error);
      } finally {
        setLoading(false);
      }
    };
      ...
      <div style={{ width: "100%", padding: "0 20px", boxSizing: "border-box" }}>
        {loading ? (
          ...
          <div className="text-center text-muted py-5">
            ...
            <p className="mt-3" style={{ fontSize: "1.2rem" }}>
              No top doctors found for this department. Please try other departments or check back later.
            </p>
          </div>
        ) : (
            ...
            {[...doctors]
              ...
              <div className="col-md-6 col-lg-4" key={doc._id} style={{ paddingBottom: "20px" }}>
                <div
                  ...
                  style={{ borderRadius: "15px", overflow: "hidden", transition: "transform 0.3s, box-shadow 0.3s", border: "none" }}
                  onMouseEnter={(e) => {
                ...
                >
                  <div style={{ height: "200px", overflow: "hidden", backgroundColor: "#f0f8ff" }}>
                    <img src={getDoctorImage(index)} alt={`Dr. ${doc.name}`} style={{ width: "100%", height: "100%", objectFit: "cover", objectPosition: "center top" }} />
                  </div>
        ...
        <div className="text-center my-5">
          <button
            ...
            style={{ borderRadius: "10px", fontWeight: "500", transition: "all 0.3s" }}
...
export default TopDoctorsByCategory;
